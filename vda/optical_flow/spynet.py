    ...
    def __init__(self):
        ...
        self.load_state_dict({strKey.replace('module', 'net'): tenWeight for strKey, tenWeight in
                              torch.hub.load_state_dict_from_url(
                                  ...
                                  file_name='spynet-' + arguments_strModel).items()})
...
def spynet_optical_flow(tenOne, tenTwo):
    global netNetwork
    ...
    # assert(intWidth == 1024) # remember that there is no guarantee for correctness, comment this line out if you
                               # acknowledge this and want to continue
    # assert(intHeight == 416) # remember that there is no guarantee for correctness, comment this line out if you
                               # acknowledge this and want to continue
