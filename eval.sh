...
# ablation
python3 eval.py --cfg config/images_only-predict_friction-farneback-resnet18-pybullet.yaml

# ablation
python3 eval.py --cfg config/optical_flow_only-predict_friction-farneback-resnet18-pybullet.yaml
python3 eval.py --cfg config/optical_flow_only-predict_friction-spynet-resnet18-pybullet.yaml

# experiment 1
python3 eval.py --cfg config/predict_friction-farneback-resnet18-pybullet.yaml
python3 eval.py --cfg config/predict_friction-spynet-resnet18-pybullet.yaml
